...
class Exercise(models.Model):
    ...
    MET = models.IntegerField(default=69,)
    ...
    numExecution = models.IntegerField(default=5)
    numSet = models.IntegerField(default=5)
    uploaded_at = models.DateTimeField(auto_now_add=True, null=True)
    is_active = models.BooleanField(default=False,)
    is_custom = models.BooleanField(default=True,)
    # parts = models.CharField(max_length=100, default='["Neck","Shoulder"]')
    parts = models.JSONField(default=list)  # Or your desired default
