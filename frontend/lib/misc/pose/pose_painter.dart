...
class PosePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (final pose in poses) {
      ...
      //   double maxX = boundingBox['maxCoor_X']!;
      //   double maxY = boundingBox['maxCoor_Y']!;

      //   double minX = boundingBox['minCoor_X']!;
      //   double minY = boundingBox['minCoor_Y']!;

      //   boundingBoxPainter(maxX, minY, maxX, maxY);

      //   boundingBoxPainter(maxX, maxY, minX, maxY);

      //   boundingBoxPainter(minX, maxY, minX, minY);

      //   boundingBoxPainter(minX, minY, maxX, minY);
      // }
      // POSES
